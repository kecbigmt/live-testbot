...
def message_text(event):
    if event.message.text == "カルーセル":
        carousel_template = CarouselTemplate(columns=[
            CarouselColumn(text='ねお　▶36,131 ♥939,597\n視聴履歴からのおすすめ', title='企画配信！！ねおのコスメ紹介LIVE', thumbnail_image_url='https://scdn.line-apps.com/obs/0hO3hM3WI5EBxVND_68-hvS2ppFmssGhUYdxYeKC5oFnMuGAUTdVVefnU1Ui97DF9CalReP3EzHXktB1EZ/f375x281',actions=[
                URITemplateAction(
